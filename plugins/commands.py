...
async def repo_(client, message):
    ...
    await message.reply("<b>The source code of MusicPlayer is public and can be found at <a href=https://github.com/ZeebFly/MusicPlayer>Github.</a> You can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True, quote=False)
    await delete_messages([message])
